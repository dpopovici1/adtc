...
<?php
	...
	function process_menu_item( $item ) {
		...
		$args = array(
			...
			'menu-item-background' => $_menu_item_background,
			'menu-item-bg-position' => $_menu_item_bg_position,
			'menu-item-megamenu' => $_menu_item_megamenu,
			'menu-item-menutitle' => $_menu_item_menutitle,
			'menu-item-cols-nums' => $_menu_item_cols_nums,
			'menu-item-text' => $_menu_item_text,
			'menu-item-columntype' => $_menu_item_columntype
		);
